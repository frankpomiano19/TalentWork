                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="etiqueta1" value="">
                                    <input type="hidden" name="etiqueta2" value="{{ $serviceProfile->id }}">
            ...
            <div class="modal fade" id="Modalpregunta">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{ csrf_field() }}
                        <input type="hidden" name="etiqueta_1" value="">
                        <input type="hidden" name="etiqueta_2" value="{{ $serviceProfile->id }}">
